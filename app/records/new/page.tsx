...
export default function NewRecordPage() {
  ...
  const { tags, addRecord, fetchTags, isLoading } = useStore()
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-2xl font-bold">创建新记录</h1>
      </div>

      <Tabs defaultValue="text" value={recordType} onValueChange={(value) => setRecordType(value as RecordType)}>
